...
var Terrain = function () {
  ...
  terTxr = new BABYLON.Texture("img/dif_ter_01.jpg", scene);
  hmTxr = new BABYLON.Texture("img/hm/hm_ter.jpg", scene);
  ...
  //skybox = BABYLON.Mesh.CreateBox("skyBox", 512, scene);
  ...
  groundMat.diffuseTexture = grid3Txr;
  ...
  waterMat = new BABYLON.WaterMaterial(
    "waterMaterial", scene, new BABYLON.Vector2(512, 512)
  );
  waterMat.bumpTexture = new BABYLON.Texture(
    "img/waterbump01.png", scene
  );
  waterMat.windForce = 0.1; // -10.0
  waterMat.windDirection = new BABYLON.Vector2(1, 1);
  waterMat.waveHeight = 0.1; // 0.5
  waterMat.bumpHeight = 0.1;
  waterMat.waveLength = 0.1;
  waterMat.waveSpeed = 5; // 50.0
  waterMat.colorBlendFactor = 0;


  //water = BABYLON.MeshBuilder.CreateBox(
  //  "waterMesh", {
  //    "depth": 512,
  //    "height": 0.1,
  //    "width": 512,
...
window.addEventListener("DOMContentLoaded", Terrain, false);
